...
// 标签配置
const tags = [
  { id: "nano", label: "Nano Banana Pro", icon: "🍌", active: true },
  { id: "design", label: "Design", icon: "🖼️", active: false },
  { id: "branding", label: "Branding", icon: "✨", active: false },
  { id: "illustration", label: "Illustration", icon: "🎨", active: false },
  { id: "ecommerce", label: "E-Commerce", icon: "🛒", active: false },
  { id: "video", label: "Video", icon: "▶️", active: false },
];
